...
class IsProgressScreen extends StatefulWidget {
  const IsProgressScreen({Key? key}) : super(key: key);

  @override
  _IsProgressScreenState createState() => _IsProgressScreenState();
}

class _IsProgressScreenState extends State<IsProgressScreen> with Helpers {
  @override
  void initState() {
    super.initState();
          ...
          if (value.tasks.isNotEmpty) {
            return ListView.builder(
              ...
              itemCount: value.tasks
                  .where((element) => element.taskState == isProgress)
