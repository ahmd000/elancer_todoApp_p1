...
import 'package:elancer_todo_p1/Screens/HomeScn/ScreensNavBar/TabBarScreens/IsProgressScreen.dart';
...
class IsDoneScreen extends StatefulWidget {
  const IsDoneScreen({Key? key}) : super(key: key);

  @override
  _IsDoneScreenState createState() => _IsDoneScreenState();
}

class _IsDoneScreenState extends State<IsDoneScreen> with Helpers {
  @override
  void initState() {
          ...
          if (value.tasks.isNotEmpty) {
            return ListView.builder(
              ...
              itemCount: value.tasks
                  .where((element) => element.taskState == isDone)
                  .length,
